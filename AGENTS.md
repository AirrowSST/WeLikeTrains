...
- User decided on 2026-09-19 that Preferences and Account are separate destinations in the bottom navigation. The persistent top identity bar is removed; notifications remain a single circular button at the top right.
