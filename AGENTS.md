...
- **Hackathon pace is an explicit priority.** Tests remain available as optional manual checks but neither pushes nor the deployment script runs them automatically. Do not claim tests were run when they were not.
