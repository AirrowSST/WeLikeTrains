...
- Verification for the integrated local map/search/routing and manual-deployment branch is in progress; record new unit and browser totals after the combined branch is tested.
