...
- The integrated production build/typecheck, 25 unit tests and all 18 Chromium browser checks pass across phone and wide-screen mobile-only projects. Coverage includes local place/station search without a network call, deployment guardrails, real OSM Rachel/Arjun/Mdm Lim routes, no OneMap browser resources, resizable one-column layout, chat route cards, foreground/simulated location, 320px no-overflow, axe and large-text/offline reload.
