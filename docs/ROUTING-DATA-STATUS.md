...
| LTA CoveredLinkWay | 7,012 features; enriches aligned OSM pedestrian edges using an 8 m tolerance | Does not invent connections across disconnected paths or claim coverage of unmapped access |
...
| LTA RoadWorks | Time-valid road-name matches warn about planned works along the bus service | Full service road names do not establish the affected subsegment, closure or measured delay; no invented blocking |
